    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            ...
            <div
                ...
                <h1 class="mb-1 font-semibold text-lg">Welcome to Your Password Vault 🔐</h1>
                <p class="mb-3 text-[#706f6c] dark:text-[#A1A09A]">This password manager helps you store, manage, and
                    generate strong passwords with ease. Here’s what you can do:</p>

                <ul class="flex flex-col mb-5 lg:mb-7">
                    <li
                        ...
                        <span class="relative py-1 bg-white dark:bg-[#161615]">
                            <span
                                class="flex items-center justify-center rounded-full bg-[#FDFDFC] dark:bg-[#161615] shadow w-3.5 h-3.5 border dark:border-[#3E3E3A] border-[#e3e3e0]">
                                <span class="rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A] w-1.5 h-1.5"></span>
                            </span>
                        </span>
                        <span>
                            <strong>Save and manage</strong> all your passwords in one secure location.
                        </span>
                    </li>
                    <li
                        class="flex items-start gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:bottom-1/2 before:top-0 before:left-[0.4rem] before:absolute">
                        <span class="relative py-1 bg-white dark:bg-[#161615]">
                            <span
                                class="flex items-center justify-center rounded-full bg-[#FDFDFC] dark:bg-[#161615] shadow w-3.5 h-3.5 border dark:border-[#3E3E3A] border-[#e3e3e0]">
                                <span class="rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A] w-1.5 h-1.5"></span>
                        ...
                        <span>
                            <strong>Generate strong passwords</strong> with a single click using the built-in generator.
                        </span>
                    </li>
                    <li
                        class="flex items-start gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:bottom-1/2 before:top-0 before:left-[0.4rem] before:absolute">
                        ...
                        <span>
                            <strong>Access your credentials</strong> from an intuitive, clean dashboard.
                        </span>
                    </li>
                </ul>
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <a href="/passwords/create"
                            class="inline-block dark:bg-[#eeeeec] dark:border-[#eeeeec] dark:text-[#1C1C1A] dark:hover:bg-white dark:hover:border-white hover:bg-black hover:border-black px-5 py-1.5 bg-[#1b1b18] rounded-sm border border-black text-white font-semibold leading-normal">
                            Add Password
                        </a>
                    </li>
                    <li>
                        <a href="/dashboard"
                            class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold px-5 py-1.5 rounded-sm transition-colors duration-200">
                            View Dashboard
                        </a>
                    </li>
                </ul>
            ...
            <div
                class="bg-[#f3f4f6] dark:bg-[#0f172a] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden">

                <!-- Password Management App Illustration -->
                <img src="{{ asset('images/bg_logo.png') }}" alt="Password Manager Illustration"
                ...
                <div
                    class="absolute inset-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg shadow-[inset_0px_   0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                </div>
            </div>
